...
export interface ReserveTicketsRequest {
  ...
  items?: TicketReservationDto[];
}

export interface ReserveTicketsItemsDto {
  ticketListingId?: number;
  unitPrice?: number;
  companyId?: number;
}
...
export const update = async (
  ...
  return customFetchEventApi<updateResponse>(getUpdateUrl(id), {
    ...options,
    method: "PUT",
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { id: number; data: CreateVenueRequest },
    TContext
  >;
  request?: SecondParameter<typeof customFetchEventApi>;
}): UseMutationOptions<
...
export type UpdateMutationResult = NonNullable<
  Awaited<ReturnType<typeof update>>
>;
export type UpdateMutationBody = CreateVenueRequest;
export type UpdateMutationError = string;

export const useUpdate = <TError = string, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof update>>,
      TError,
...
export type reserveTicketsResponse200 = {
  data: ReserveTicketsResponse;
  status: 200;
};

export type reserveTicketsResponse400 = {
  data: string;
  status: 400;
};

export type reserveTicketsResponse401 = {
  data: string;
  status: 401;
};

export type reserveTicketsResponse403 = {
  data: string;
  status: 403;
};

export type reserveTicketsResponse404 = {
  data: string;
  status: 404;
};

export type reserveTicketsResponse409 = {
  data: string;
  status: 409;
};

export type reserveTicketsResponse500 = {
  data: string;
  status: 500;
};

export type reserveTicketsResponseSuccess = reserveTicketsResponse200 & {
  headers: Headers;
};
export type reserveTicketsResponseError = (
  | reserveTicketsResponse400
  | reserveTicketsResponse401
  | reserveTicketsResponse403
  | reserveTicketsResponse404
  | reserveTicketsResponse409
  | reserveTicketsResponse500
) & {
  headers: Headers;
};

export type reserveTicketsResponse =
  | reserveTicketsResponseSuccess
  | reserveTicketsResponseError;

export const getReserveTicketsUrl = () => {
  return `/ticket-listings/reserve`;
};

export const reserveTickets = async (
  reserveTicketsRequest: ReserveTicketsRequest,
  options?: RequestInit,
): Promise<reserveTicketsResponse> => {
  return customFetchEventApi<reserveTicketsResponse>(getReserveTicketsUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(reserveTicketsRequest),
  });
};

export const getReserveTicketsMutationOptions = <
  TError = string,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof reserveTickets>>,
    TError,
    { data: ReserveTicketsRequest },
    TContext
  >;
  request?: SecondParameter<typeof customFetchEventApi>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = ["reserveTickets"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return reserveTickets(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type ReserveTicketsMutationResult = NonNullable<
  Awaited<ReturnType<typeof reserveTickets>>
>;
export type ReserveTicketsMutationBody = ReserveTicketsRequest;
export type ReserveTicketsMutationError = string;

export const useReserveTickets = <TError = string, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof reserveTickets>>,
      TError,
  ...
  TContext
> => {
  return useMutation(getReserveTicketsMutationOptions(options), queryClient);
};
...
export type releaseReservationResponse400 = {
  data: string;
  status: 400;
};

export type releaseReservationResponse401 = {
  data: string;
  status: 401;
};

export type releaseReservationResponse403 = {
  data: string;
  status: 403;
};

export type releaseReservationResponse404 = {
  data: string;
  status: 404;
};

export type releaseReservationResponse409 = {
  data: string;
  status: 409;
};

export type releaseReservationResponse500 = {
  data: string;
  status: 500;
};

export type releaseReservationResponseSuccess =
  releaseReservationResponse200 & {
    headers: Headers;
  };
export type releaseReservationResponseError = (
  | releaseReservationResponse400
  | releaseReservationResponse401
  | releaseReservationResponse403
  | releaseReservationResponse404
  | releaseReservationResponse409
  | releaseReservationResponse500
) & {
  headers: Headers;
};

export type releaseReservationResponse =
  | releaseReservationResponseSuccess
  | releaseReservationResponseError;

export const getReleaseReservationUrl = (orderReference: string) => {
  return `/ticket-listings/release/${orderReference}`;
};
...
export const releaseReservation = async (
  ...
  return customFetchEventApi<releaseReservationResponse>(
    getReleaseReservationUrl(orderReference),
    {
      ...options,
      method: "POST",
    },
...
export const getReleaseReservationMutationOptions = <
  TError = string,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
> => {
  ...
  > = (props) => {
    ...
    return releaseReservation(orderReference, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type ReleaseReservationMutationResult = NonNullable<
  Awaited<ReturnType<typeof releaseReservation>>
>;

export type ReleaseReservationMutationError = string;

export const useReleaseReservation = <TError = string, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof releaseReservation>>,
      TError,
...
> => {
  return useMutation(
    getReleaseReservationMutationOptions(options),
    queryClient,
  );
};
